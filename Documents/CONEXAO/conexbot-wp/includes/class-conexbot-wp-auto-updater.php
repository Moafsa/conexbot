<?php
/**
 * Conexbot WP Auto Updater Class
...
class Conexbot_WP_Auto_Updater {
    
    private $api_url = 'https://app.conext.click/api/v1/ml/update';
    private $plugin_slug = 'conexbot-wp';
    private $plugin_file;
    ...
    public function check_update($transient) {
        ...
        if ($plugin_info && version_compare(CONEXBOT_WP_VERSION, $plugin_info->version, '<')) {
            $obj = new stdClass();
    ...
    private function get_remote_version() {
        $cache_key = 'conexbot_wp_remote_version';
    ...
    public function plugin_info($false, $action, $args) {
        ...
        $args = new stdClass();
        $args->name = 'Conexbot Automação & CRM (WhatsApp)';
