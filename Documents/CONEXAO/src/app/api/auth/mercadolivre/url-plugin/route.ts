...
export async function GET(req: Request) {
    try {
        ...
        const accountId = searchParams.get("account_id") || "0";
        ...
        // Pass composite state: tenantId__accountId__shopUrl__wpRedirectUri
        const state = `${tenantId}__${accountId}__${encodeURIComponent(shopUrl)}__${encodeURIComponent(wpRedirectUri)}`;
