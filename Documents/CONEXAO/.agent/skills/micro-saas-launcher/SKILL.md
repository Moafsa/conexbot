...
description: "Expert in launching small, focused SaaS products fast - the indie hacker approach to building profitable software. Covers idea validation, MVP development, pricing, launch strategies, and growing early traction."
version: 1.0.0
---
...
Works well with: `frontend-design`, `backend-specialist`, `stripe`, `seo-fundamentals`

## When to Use
This skill is applicable when launching small, focused SaaS products, validating ideas, building MVPs, or setting pricing strategies for indie projects.
