...
export default function Shell({ children, branding, alertBanner, userPlans }: { children: React.ReactNode, branding?: any, alertBanner?: React.ReactNode, userPlans?: { hasPrimary: boolean, hasWriter: boolean } }) {
    return (
        <div className="h-screen w-full bg-black text-white flex flex-col overflow-hidden">
            {alertBanner}
            <div className="flex flex-1 overflow-hidden min-h-0">
                <Sidebar branding={branding} userPlans={userPlans} />
